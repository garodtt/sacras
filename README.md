...
- **Personagem**: pertence a 1 usuário; só o dono edita. Quem criou uma
  campanha (ou o Admin) também **vê** os personagens vinculados a ela,
  mas não edita os de outra pessoa.
...
└── src/
    ...
    │   ├── combate/
    │   │   └── PopupReferencia.jsx  # shell de popup (tabelas de Iniciativa/Dor no rastreador) — novo 13/07
    ...
    └── routes/
        ...
        ├── EsqueciSenha.jsx
        ├── RedefinirSenha.jsx
        ├── Painel.jsx            # painel único: personagens, campanhas, convites
